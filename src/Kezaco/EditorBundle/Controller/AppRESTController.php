 ...
 * @RouteResource("App")
 */
class AppRESTController extends VoryxController
{
    /**
     * Get a App entity
     *
     ...
     *
     */
    public function getAction(App $entity)
    {
        return $entity;
    }
    /**
    ...
    /**
     * Partial Update to a App entity.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
     * @param Request $request
     ...
     * @return Response
*/
    public function patchAction(Request $request, App $entity)
    {
